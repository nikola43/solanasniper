...
export async function processRaydiumPool(id: PublicKey, poolState: LiquidityStateV4) {
  ...
  try {
    ...
    const tokenAAmount = 0.03 // e.g. 0.01 SOL -> B_TOKEN
    ...
    */
    ...
    // const tx = await raydiumSwap.getSwapTransactionV2(
    ...
    // tokenAccount.poolKeys = createPoolKeys(id, poolState, tokenAccount.market!);

    // const inputToken = poolState.quoteMint.toBase58() === "So11111111111111111111111111111111111111112" ? poolState.quoteMint.toBase58() : poolState.baseMint.toBase58();
    // const outputToken = poolState.quoteMint.toBase58() === "So11111111111111111111111111111111111111112" ? poolState.baseMint.toBase58() : poolState.quoteMint.toBase58();

    // console.log(`Input token: ${inputToken}`);
    // console.log(`Output token: ${outputToken}`);
    // const poolKeys = await getPoolKeys(id.toBase58(), connection);
    // const poolKeys = tokenAccount.poolKeys;
    // console.log(poolKeys);
